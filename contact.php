...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Contact For Any Request</h1>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>Nagoya City, Aichi Prefecture, Japan</span>
                                </div>
                            </div>
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>Duc.NH210192@sis.hust.edu.vn</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <iframe src="https://www.google.com/maps/d/embed?mid=1jshe1rm4X6Qk-NHEPpP2QaZNJf8&hl=en&ehbc=2E312F" width="540" height="450" frameborder="0" style="min-height: 400px; border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                    <div id="frmContact" class="col-md-6">
                        <div id="mail-status"></div>
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <p class="mb-4">Any questions or remarks? Write us a meesage.</p>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
